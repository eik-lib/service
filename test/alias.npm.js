...
tap.test('alias package - put alias, then get file overview through alias - scoped', async (t) => {
    ...
    t.equals(uploaded.headers.get('location'), `${address}/npm/@cuz/fuzz/8.4.1`, 'on PUT of package, server should respond with a location header');
    ...
    t.equals(alias.headers.get('location'), `${address}/npm/@cuz/fuzz/v8`, 'on PUT of alias, server should respond with a location header');
    ...
    t.equals(redirect.headers.get('location'), `${address}/npm/@cuz/fuzz/8.4.1`, 'on GET of file through alias, server should respond with a location header');
...
tap.test('alias package - put alias, then get file overview through alias - non scoped', async (t) => {
    ...
    t.equals(uploaded.status, 303, 'on PUT of package, server should respond with a 303 redirect');
    t.equals(uploaded.headers.get('location'), `${address}/npm/fuzz/8.4.1`, 'on PUT of package, server should respond with a location header');
    ...
    t.equals(alias.status, 303, 'on PUT of alias, server should respond with a 303 redirect');
    t.equals(alias.headers.get('location'), `${address}/npm/fuzz/v8`, 'on PUT of alias, server should respond with a location header');
    ...
    t.equals(redirect.status, 307, 'on GET of file through alias, server should respond with a 307 redirect');
    t.equals(redirect.headers.get('location'), `${address}/npm/fuzz/8.4.1`, 'on GET of file through alias, server should respond with a location header');
...
tap.test('alias package - put alias, then get file through alias - scoped', async (t) => {
    ...
    t.equals(redirect.status, 307, 'on GET of file through alias, server should respond with a 307 redirect');
    t.equals(redirect.headers.get('location'), `${address}/npm/@cuz/fuzz/8.4.1/main/index.js`, 'on GET of file through alias, server should respond with a location header');
...
tap.test('alias package - put alias, then get file through alias - non scoped', async (t) => {
    ...
    t.equals(redirect.status, 307, 'on GET of file through alias, server should respond with a 307 redirect');
    t.equals(redirect.headers.get('location'), `${address}/npm/fuzz/8.4.1/main/index.js`, 'on GET of file through alias, server should respond with a location header');
