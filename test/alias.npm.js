...
tap.test('alias package - put alias, then get file overview through alias - scoped', async (t) => {
    ...
    t.equal(alias.headers.get('location'), `/npm/@cuz/fuzz/v8`, 'on PUT of alias, server should respond with a location header');
    ...
    t.equal(redirect.headers.get('location'), `/npm/@cuz/fuzz/8.4.1`, 'on GET of file through alias, server should respond with a location header');
...
tap.test('alias package - put alias, then get file overview through alias - non scoped', async (t) => {
    ...
    t.equal(alias.status, 303, 'on PUT of alias, server should respond with a 303 redirect');
    t.equal(alias.headers.get('location'), `/npm/fuzz/v8`, 'on PUT of alias, server should respond with a location header');
    ...
    t.equal(redirect.status, 302, 'on GET of file through alias, server should respond with a 302 redirect');
    t.equal(redirect.headers.get('location'), `/npm/fuzz/8.4.1`, 'on GET of file through alias, server should respond with a location header');
...
tap.test('alias package - put alias, then get file through alias - scoped', async (t) => {
    ...
    t.equal(redirect.status, 302, 'on GET of file through alias, server should respond with a 302 redirect');
    t.equal(redirect.headers.get('location'), `/npm/@cuz/fuzz/8.4.1/main/index.js`, 'on GET of file through alias, server should respond with a location header');
...
tap.test('alias package - put alias, then get file through alias - non scoped', async (t) => {
    ...
    t.equal(redirect.status, 302, 'on GET of file through alias, server should respond with a 302 redirect');
    t.equal(redirect.headers.get('location'), `/npm/fuzz/8.4.1/main/index.js`, 'on GET of file through alias, server should respond with a location header');
