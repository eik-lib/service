...
test("npm packages - no auth token on PUT - scoped", async () => {
	const formData = new FormData();
...
test("npm packages - no auth token on PUT - non scoped", async () => {
	const formData = new FormData();
	formData.append("package", new Blob([fs.readFileSync(FIXTURE_PKG)]));
...
test("npm packages - put pkg -> get file - scoped successfully uploaded", async (t) => {
	const formData = new FormData();
	formData.append("package", new Blob([fs.readFileSync(FIXTURE_PKG)]));
...
test("npm packages - put pkg -> get file - non scoped successfully uploaded", async (t) => {
	const formData = new FormData();
	formData.append("package", new Blob([fs.readFileSync(FIXTURE_PKG)]));
...
test("npm packages - get package overview - scoped", async (t) => {
	const formData = new FormData();
	formData.append("package", new Blob([fs.readFileSync(FIXTURE_PKG)]));
...
test("npm packages - get package overview - non scoped", async (t) => {
	const formData = new FormData();
	formData.append("package", new Blob([fs.readFileSync(FIXTURE_PKG)]));
...
test("npm packages - get package versions - scoped", async (t) => {
	// PUT files on server
...
test("npm packages - get package versions - non scoped", async (t) => {
	// PUT files on server
