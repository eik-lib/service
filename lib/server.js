...
const EikService = class EikService {
    constructor({
        ...
        this._versionsGet = new http.VersionsGet({ sink: this.sink, logger: this.log });
        this._aliasPost = new http.AliasPost({ sink: this.sink, logger: this.log });
        this._aliasDel = new http.AliasDel({ sink: this.sink, logger: this.log });
        this._aliasGet = new http.AliasGet({ sink: this.sink, logger: this.log });
        this._aliasPut = new http.AliasPut({ sink: this.sink, logger: this.log });
        this._authPost = new http.AuthPost({ authKey: config.get('basicAuth').key, logger: this.log });
        this._pkgLog = new http.PkgLog({ sink: this.sink, logger: this.log });
        this._pkgGet = new http.PkgGet({ sink: this.sink, logger: this.log });
        this._pkgPut = new http.PkgPut({ sink: this.sink, logger: this.log });
        this._mapGet = new http.MapGet({ sink: this.sink, logger: this.log });
        this._mapPut = new http.MapPut({ sink: this.sink, logger: this.log });
